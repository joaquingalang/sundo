...
import { ArrowLeft, CheckCircle2, ShieldCheck, FileText, BrainCircuit, ShieldAlert } from "lucide-react";
...
export default function ConsultantStep2Page() {
  ...
  const requiredDocs = [
    { id: "BIR Certificate", label: "BIR Certificate / TIN", desc: "Form 2303 or verified TIN ID." },
    { id: "Business Permit", label: "Business/Local Permit", desc: "Relevant to your area of operation." },
    { id: "Government ID", label: "Professional ID", desc: "PRC, Unified ID, or Passport." },
  ];
    ...
    <div className="space-y-10">
      <div className="flex items-center gap-4">
        ...
        <div className="space-y-1 text-left">
          <h1 className="font-heading text-3xl font-bold text-rhino">Professional Verification</h1>
          <p className="font-body text-rhino/60 text-sm">We verify all experts to maintain ecosystem trust.</p>
        </div>
      </div>
      ...
      <div className="bg-rhino/5 rounded-[2rem] p-8 border border-akaroa/20 space-y-8">
        <div className="flex items-center gap-4 p-4 rounded-2xl bg-white border border-akaroa/10 shadow-sm">
          ...
          <p className="font-body text-xs text-rhino/70 text-left">
            Gemini AI will scan your professional documents. Verified consultants get a "Trust Badge" on their profile.
          </p>
        </div>
