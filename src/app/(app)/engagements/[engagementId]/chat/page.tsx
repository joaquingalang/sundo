...
export default function EngagementChatPage() {
  ...
  const tabs = [
    ...
    { label: engagement?.mode === "consultant" || auth.currentUser?.uid === engagement?.consultantId ? "Project Manager" : "Task Tracker", href: `/engagements/${engagementId}/milestones`, icon: ShieldCheck },
